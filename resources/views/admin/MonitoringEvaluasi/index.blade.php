                            ...
                            <div class="card-body">
                                ...
                                @if (Auth::guard('pengguna')->user()->level === 'Super Admin' && isset($allOpds) && $allOpds->isNotEmpty())
                                    ...
                                    <div class="card-body border-top pt-3">
                                            ...
                                            <div class="row g-2 align-items-end">
                                                <div class="col-md-5">
                                                    <label for="opd_id_filter" class="form-label text-sm">Perangkat
                                                        Daerah</label>
                                                    <select name="opd_id" id="opd_id_filter"
                                        ...
                                        <h5 class="card-title" style="padding: 0 !important; margin-bottom: 5px;">Kirim
                                            Reminder
                                            WhatsApp</h5>
                                        <form action="{{ route('monev.reminder.manual') }}" method="POST"
                                            id="formReminderManual">
                                            @csrf
                                            <div class="row g-2 align-items-end">
                                                <div class="col-md-9">
                                                ...
                                                <input type="hidden" name="deadline_tanggal" id="deadlineTanggal">
                                                <input type="hidden" name="deadline_jam" id="deadlineJam">
                                            ...
                                            <tbody id="dataTabelBody">
                                                @foreach ($monev as $data)
                                                    <tr id="row-{{ $data->id }}">
                                                        ...
                                                        <td class="text-center">{{ $data->rencanakerja->lokasi ?? '-' }}
                                                        </td>
                                                        <td class="text-center">{{ $data->rencanakerja->volume ?? '-' }}
                                                        </td>
                                                        <td class="text-center">{{ $data->rencanakerja->satuan ?? '-' }}
                                                        </td>
                                                        <td class="text-center">{{ $data->rencanakerja->tahun ?? '-' }}
                                                        </td>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            @else
                                                                <span
                                                                    class="badge bg-secondary">{{ $data->status }}</span>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td class="text-center align-middle td-aksi-container">
                                                            <div
                                                                ...
                                                                <form
                                                                    ...
                                                                    class="formReminderPerData">
                                                                    @csrf
                                                                    <input type="hidden" name="deadline_tanggal"
                                                                        class="deadlineTanggalPerData">
                                                                    <input type="hidden" name="deadline_jam"
                                                                        class="deadlineJamPerData">
                                                                    <button type="submit"
                                                                ...
                                                                @php
                                                                    ...
                                                                    if ($data->edit_open_until) {
                                                                        $deadlineExpired = now()->gt(
                                                                            \Carbon\Carbon::parse(
                                                                                $data->edit_open_until,
                                                                            ),
                                                                        );
                                                                    }

                                                                    $canEdit = !$data->is_locked && !$deadlineExpired;
                                                                @endphp
                                                                    ...
                                                                    <div class="mt-4">
                                                                        ...
                                                                        @else
                                                                            <div
                                                                                ...
                                                                                <p class="mb-0 mt-3 text-hijau-kustom">
                                                                                    Lokasi
                                                                                    belum
                                                                                    ditandai</p>
                                                                            </div>
                                                                    ...
                                                                    <div class="foto-container-scrollable">
                                                                        ...
                                                                        @else
                                                                            <div
                                                                                ...
                                                                                <p class="mb-0 mt-2 text-hijau-kustom">
                                                                                    Belum
                                                                                    ada foto
                                                                                </p>
                                                                            </div>
                    ...
                    if (formReminder) {
                        formReminder.addEventListener('submit', async function(e) {
                            ...
                            <div style="text-align:left; margin: 0 20px;">
                                <label for="swal-tanggal" style="display:block; margin-bottom:6px;">
                                    Data dibuka sampai tanggal
                                </label>
                                <input id="swal-tanggal" type="date" class="swal2-input" style="margin:0 auto 12px auto;">

                                <label for="swal-jam" style="display:block; margin-bottom:6px;">
                                    Jam
                                </label>
                                <input id="swal-jam" type="time" class="swal2-input" style="margin:0 auto;">
                            </div>
                        `,
                                showCancelButton: true,
                    ...
                    document.querySelectorAll('.formReminderPerData').forEach(form => {
                        form.addEventListener('submit', async function(e) {
                            ...
                            const {
                                ...
                                html: `
                            <div style="text-align:left; margin: 0 20px;">
                                <label for="swal-tanggal-perdata" style="display:block; margin-bottom:6px;">
                                    Data dibuka sampai tanggal
                                </label>
                                <input id="swal-tanggal-perdata" type="date" class="swal2-input" style="margin:0 auto 12px auto;">

                                <label for="swal-jam-perdata" style="display:block; margin-bottom:6px;">
                                    Jam
                                </label>
            ...
            <script>
                function showLockedAlert() {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Data Terkunci',
                        text: 'Akses edit masih ditutup atau batas waktu edit sudah berakhir.'
                    });
                }
            </script>
        @endpush
